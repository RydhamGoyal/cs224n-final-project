...
if __name__ == "__main__":
    ...
    p.add_argument("--test", default="predictions/generated_sonnets_dev.txt", help="Generated sonnets file")
    p.add_argument("--gold", default="data/TRUE_sonnets_held_out_dev.txt", help="Gold reference file")
    args = p.parse_args()
    score = test_sonnet(args.test, args.gold)
    print(f"chrF: {score:.3f}")